...
void draw() {
  ...
  // get the newest Colour Lover's palette
  // you can access the first twenty new palettes by changing 0 for 0-19. 
  ColourLoversPalette palette = cl.getNthNewPalette(0);
