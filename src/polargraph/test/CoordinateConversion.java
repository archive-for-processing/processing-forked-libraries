...
public class CoordinateConversion extends PApplet {
...
public void draw() {
	...
	text("Mouse: ", textPos.x, textPos.y);
	StringBuilder sb = new StringBuilder().append("(").append(mousePos.x).append(", ").append(mousePos.y).append(")");
	text(sb.toString(), textPos.x+260, textPos.y);

	textPos.y += rowHeight;
	text("Mouse over machine: ", textPos.x, textPos.y);
	sb = new StringBuilder().append("(").append(machinePos.x).append(", ").append(machinePos.y).append(")");
	text(sb.toString(), textPos.x+260, textPos.y);

	textPos.y += rowHeight;
	text("Mouse over input panel: ", textPos.x, textPos.y);
	sb = new StringBuilder().append("(").append(inputPos.x).append(", ").append(inputPos.y).append(")");
	text(sb.toString(), textPos.x+260, textPos.y);

	textPos.y += rowHeight;
	text("Cartesian on machine model: ", textPos.x, textPos.y);
	sb = new StringBuilder().append("(").append(cartesianPos.x).append(", ").append(cartesianPos.y).append(")");
	text(sb.toString(), textPos.x+260, textPos.y);

	textPos.y += rowHeight;
	text("Native on machine model: ", textPos.x, textPos.y);
	sb = new StringBuilder().append("(").append(nativePos.x).append(", ").append(nativePos.y).append(")");
	text(sb.toString(), textPos.x+260, textPos.y);
