...
public class StarEmitter extends Mover implements Emitter {
	protected Random mRandom = new Random();

	public StarEmitter(PApplet p) {
		super(p);
	}
	...
	public Particle emit() {
		...
		if (cp == null) {
			cp = new StarParticle(getPApplet(), mLocation, PVector.random2D(), new PVector(0, 0), 5,
